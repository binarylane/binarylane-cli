...
from ...models.ssh_keys_response import SshKeysResponse
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[Any, SshKeysResponse]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[Any, SshKeysResponse]]:
    return Response(
