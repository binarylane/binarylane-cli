...
from ...models.forwarding_rules_request import ForwardingRulesRequest
...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/v2/load_balancers/{load_balancer_id}/forwarding_rules".format(
        client.base_url, load_balancer_id=load_balancer_id
    )
