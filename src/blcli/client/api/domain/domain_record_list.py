...
from ...models.domain_record_type import DomainRecordType
from ...models.domain_records_response import DomainRecordsResponse
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[Any, DomainRecordsResponse, ProblemDetails]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[Any, DomainRecordsResponse, ProblemDetails]]:
    return Response(
