...
def _parse_response(*, response: httpx.Response) -> Optional[Union[Any, DomainResponse, ProblemDetails]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[Any, DomainResponse, ProblemDetails]]:
    return Response(
