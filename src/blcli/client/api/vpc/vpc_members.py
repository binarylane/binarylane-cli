...
from ...models.vpc_members_response import VpcMembersResponse
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[Any, ProblemDetails, VpcMembersResponse]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[Any, ProblemDetails, VpcMembersResponse]]:
    return Response(
