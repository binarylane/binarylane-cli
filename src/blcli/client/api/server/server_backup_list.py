...
from ...models.backups_response import BackupsResponse
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[Any, BackupsResponse, ProblemDetails]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[Any, BackupsResponse, ProblemDetails]]:
    return Response(
