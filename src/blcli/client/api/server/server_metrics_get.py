...
from ...models.sample_set_response import SampleSetResponse
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[Any, ProblemDetails, SampleSetResponse]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[Any, ProblemDetails, SampleSetResponse]]:
    return Response(
