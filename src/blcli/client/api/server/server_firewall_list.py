...
def _parse_response(*, response: httpx.Response) -> Optional[Union[AdvancedFirewallRulesResponse, Any, ProblemDetails]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[AdvancedFirewallRulesResponse, Any, ProblemDetails]]:
    return Response(
