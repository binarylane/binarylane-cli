...
from ...models.server_neighbors_response import ServerNeighborsResponse
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[Any, ProblemDetails, ServerNeighborsResponse]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[Any, ProblemDetails, ServerNeighborsResponse]]:
    return Response(
