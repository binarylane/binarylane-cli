...
from binarylane.api.server_actions.post_v_2_servers_server_id_actions_change_source_and_destination_check import (
    sync_detailed,
)
...
class CommandRequest:
    ...
    def __init__(self, server_id: int, json_body: ChangeSourceAndDestinationCheck) -> None:
