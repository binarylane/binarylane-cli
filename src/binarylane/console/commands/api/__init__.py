...
class GetV2Account(ModuleRunner):
    ...
    def module_path(self) -> str:
        return ".commands.api.get_v2_account"
...
class GetV2ActionsActionId(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_actions_action_id"
...
class GetV2Actions(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_actions"
...
class PostV2ActionsActionIdProceed(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v2_actions_action_id_proceed"
...
class GetV2CustomersMyBalance(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_customers_my_balance"
...
class GetV2CustomersMyInvoicesInvoiceId(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_customers_my_invoices_invoice_id"
...
class GetV2CustomersMyInvoices(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_customers_my_invoices"
...
class GetV2CustomersMyUnpaidPaymentFailedInvoices(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_customers_my_unpaid_payment_failed_invoices"
...
class GetV2DataUsagesServerIdCurrent(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_data_usages_server_id_current"
...
class GetV2DataUsagesCurrent(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_data_usages_current"
...
class GetV2DomainsNameservers(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_domains_nameservers"
...
class PostV2DomainsRefreshNameserverCache(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v2_domains_refresh_nameserver_cache"
...
class GetV2Domains(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_domains"
...
class PostV2Domains(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v2_domains"
...
class GetV2DomainsDomainName(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_domains_domain_name"
...
class DeleteV2DomainsDomainName(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.delete_v2_domains_domain_name"
...
class GetV2DomainsDomainNameRecords(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_domains_domain_name_records"
...
class PostV2DomainsDomainNameRecords(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v2_domains_domain_name_records"
...
class GetV2DomainsDomainNameRecordsRecordId(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_domains_domain_name_records_record_id"
...
class PutV2DomainsDomainNameRecordsRecordId(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.put_v2_domains_domain_name_records_record_id"
...
class DeleteV2DomainsDomainNameRecordsRecordId(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.delete_v2_domains_domain_name_records_record_id"
...
class GetV2FailoverIpsServerId(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_failover_ips_server_id"
...
class PostV2FailoverIpsServerId(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v2_failover_ips_server_id"
...
class GetV2FailoverIpsServerIdAvailable(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_failover_ips_server_id_available"
...
class GetV2Images(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_images"
...
class GetV2ImagesImageIdOrSlug(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_images_image_id_or_slug"
...
class PutV2ImagesImageId(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.put_v2_images_image_id"
...
class GetV2ImagesImageIdDownload(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_images_image_id_download"
...
class GetV2AccountKeysKeyId(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_account_keys_key_id"
...
class PutV2AccountKeysKeyId(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.put_v2_account_keys_key_id"
...
class DeleteV2AccountKeysKeyId(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.delete_v2_account_keys_key_id"
...
class GetV2AccountKeys(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_account_keys"
...
class PostV2AccountKeys(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v2_account_keys"
...
class GetV2LoadBalancersLoadBalancerId(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_load_balancers_load_balancer_id"
...
class PutV2LoadBalancersLoadBalancerId(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.put_v2_load_balancers_load_balancer_id"
...
class DeleteV2LoadBalancersLoadBalancerId(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.delete_v2_load_balancers_load_balancer_id"
...
class GetV2LoadBalancers(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_load_balancers"
...
class PostV2LoadBalancers(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v2_load_balancers"
...
class GetV2LoadBalancersAvailability(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_load_balancers_availability"
...
class PostV2LoadBalancersLoadBalancerIdServers(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v2_load_balancers_load_balancer_id_servers"
...
class DeleteV2LoadBalancersLoadBalancerIdServers(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.delete_v2_load_balancers_load_balancer_id_servers"
...
class PostV2LoadBalancersLoadBalancerIdForwardingRules(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v2_load_balancers_load_balancer_id_forwarding_rules"
...
class DeleteV2LoadBalancersLoadBalancerIdForwardingRules(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.delete_v2_load_balancers_load_balancer_id_forwarding_rules"
...
class GetV2Regions(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_regions"
...
class GetV2ReverseNamesIpv6(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_reverse_names_ipv6"
...
class PostV2ReverseNamesIpv6(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v2_reverse_names_ipv6"
...
class GetV2SamplesetsServerIdLatest(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_samplesets_server_id_latest"
...
class GetV2SamplesetsServerId(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_samplesets_server_id"
...
class GetV2ServersServerIdActions(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_servers_server_id_actions"
...
class PostV2ServersServerIdActionsChangeThresholdAlerts(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v_2_servers_server_id_actions_change_threshold_alerts"
...
class PostV2ServersServerIdActionsIsRunning(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v_2_servers_server_id_actions_is_running"
...
class PostV2ServersServerIdActionsPing(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v_2_servers_server_id_actions_ping"
...
class PostV2ServersServerIdActionsUncancel(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v_2_servers_server_id_actions_uncancel"
...
class PostV2ServersServerIdActionsUptime(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v_2_servers_server_id_actions_uptime"
...
class PostV2ServersServerIdActionsAttachBackup(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v_2_servers_server_id_actions_attach_backup"
...
class PostV2ServersServerIdActionsChangeBackupSchedule(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v_2_servers_server_id_actions_change_backup_schedule"
...
class PostV2ServersServerIdActionsChangeManageOffsiteBackupCopies(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v_2_servers_server_id_actions_change_manage_offsite_backup_copies"
...
class PostV2ServersServerIdActionsChangeOffsiteBackupLocation(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v_2_servers_server_id_actions_change_offsite_backup_location"
...
class PostV2ServersServerIdActionsCloneUsingBackup(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v_2_servers_server_id_actions_clone_using_backup"
...
class PostV2ServersServerIdActionsDetachBackup(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v_2_servers_server_id_actions_detach_backup"
...
class PostV2ServersServerIdActionsDisableBackups(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v_2_servers_server_id_actions_disable_backups"
...
class PostV2ServersServerIdActionsEnableBackups(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v_2_servers_server_id_actions_enable_backups"
...
class PostV2ServersServerIdActionsRestore(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v_2_servers_server_id_actions_restore"
...
class PostV2ServersServerIdActionsTakeBackup(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v_2_servers_server_id_actions_take_backup"
...
class PostV2ServersServerIdActionsPasswordReset(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v_2_servers_server_id_actions_password_reset"
...
class PostV2ServersServerIdActionsPowerCycle(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v_2_servers_server_id_actions_power_cycle"
...
class PostV2ServersServerIdActionsPowerOff(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v_2_servers_server_id_actions_power_off"
...
class PostV2ServersServerIdActionsPowerOn(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v_2_servers_server_id_actions_power_on"
...
class PostV2ServersServerIdActionsReboot(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v_2_servers_server_id_actions_reboot"
...
class PostV2ServersServerIdActionsShutdown(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v_2_servers_server_id_actions_shutdown"
...
class PostV2ServersServerIdActionsChangeAdvancedFeatures(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v_2_servers_server_id_actions_change_advanced_features"
...
class PostV2ServersServerIdActionsChangeAdvancedFirewallRules(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v_2_servers_server_id_actions_change_advanced_firewall_rules"
...
class PostV2ServersServerIdActionsChangeKernel(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v_2_servers_server_id_actions_change_kernel"
...
class PostV2ServersServerIdActionsChangePartner(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v_2_servers_server_id_actions_change_partner"
...
class PostV2ServersServerIdActionsDisableSelinux(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v_2_servers_server_id_actions_disable_selinux"
...
class PostV2ServersServerIdActionsRebuild(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v_2_servers_server_id_actions_rebuild"
...
class PostV2ServersServerIdActionsResize(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v_2_servers_server_id_actions_resize"
...
class PostV2ServersServerIdActionsAddDisk(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v_2_servers_server_id_actions_add_disk"
...
class PostV2ServersServerIdActionsResizeDisk(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v_2_servers_server_id_actions_resize_disk"
...
class PostV2ServersServerIdActionsDeleteDisk(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v_2_servers_server_id_actions_delete_disk"
...
class PostV2ServersServerIdActionsChangeIpv6ReverseNameservers(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v_2_servers_server_id_actions_change_ipv_6_reverse_nameservers"
...
class PostV2ServersServerIdActionsChangeReverseName(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v_2_servers_server_id_actions_change_reverse_name"
...
class PostV2ServersServerIdActionsRename(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v_2_servers_server_id_actions_rename"
...
class PostV2ServersServerIdActionsChangeIpv6(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v_2_servers_server_id_actions_change_ipv_6"
...
class PostV2ServersServerIdActionsChangePortBlocking(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v_2_servers_server_id_actions_change_port_blocking"
...
class PostV2ServersServerIdActionsEnableIpv6(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v_2_servers_server_id_actions_enable_ipv_6"
...
class PostV2ServersServerIdActionsChangeNetwork(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v_2_servers_server_id_actions_change_network"
...
class PostV2ServersServerIdActionsChangeSeparatePrivateNetworkInterface(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v_2_servers_server_id_actions_change_separate_private_network_interface"
...
class PostV2ServersServerIdActionsChangeSourceAndDestinationCheck(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v_2_servers_server_id_actions_change_source_and_destination_check"
...
class PostV2ServersServerIdActionsChangeVpcIpv4(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v_2_servers_server_id_actions_change_vpc_ipv_4"
...
class GetV2ServersServerId(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_servers_server_id"
...
class DeleteV2ServersServerId(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.delete_v2_servers_server_id"
...
class GetV2Servers(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_servers"
...
class PostV2Servers(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v2_servers"
...
class GetV2ServersServerIdActionsActionId(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_servers_server_id_actions_action_id"
...
class GetV2ServersServerIdAdvancedFirewallRules(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_servers_server_id_advanced_firewall_rules"
...
class GetV2ServersServerIdAvailableAdvancedFeatures(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_servers_server_id_available_advanced_features"
...
class GetV2ServersServerIdBackups(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_servers_server_id_backups"
...
class PostV2ServersServerIdBackups(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v2_servers_server_id_backups"
...
class GetV2ServersServerIdKernels(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_servers_server_id_kernels"
...
class GetV2ServersServerIdSnapshots(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_servers_server_id_snapshots"
...
class GetV2ServersServerIdThresholdAlerts(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_servers_server_id_threshold_alerts"
...
class GetV2ServersThresholdAlerts(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_servers_threshold_alerts"
...
class GetV2ServersServerIdSoftware(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_servers_server_id_software"
...
class GetV2ServersServerIdUserData(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_servers_server_id_user_data"
...
class GetV2ServersServerIdConsole(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_servers_server_id_console"
...
class GetV2Sizes(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_sizes"
...
class GetV2SoftwareSoftwareId(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_software_software_id"
...
class GetV2Software(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_software"
...
class GetV2SoftwareOperatingSystemOperatingSystemIdOrSlug(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_software_operating_system_operating_system_id_or_slug"
...
class GetV2VpcsVpcId(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_vpcs_vpc_id"
...
class PutV2VpcsVpcId(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.put_v2_vpcs_vpc_id"
...
class DeleteV2VpcsVpcId(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.delete_v2_vpcs_vpc_id"
...
class PatchV2VpcsVpcId(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.patch_v2_vpcs_vpc_id"
...
class GetV2Vpcs(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_vpcs"
...
class PostV2Vpcs(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.post_v2_vpcs"
...
class GetV2VpcsVpcIdMembers(ModuleRunner):
    ...
    @property
    def module_path(self) -> str:
        return ".commands.api.get_v2_vpcs_vpc_id_members"
