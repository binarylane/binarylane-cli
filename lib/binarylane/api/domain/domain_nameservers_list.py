...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[Any, LocalNameserversResponse]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[Any, LocalNameserversResponse]]:
    return Response(
