...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/v2/servers/{server_id}/actions#DetachBackup".format(client.base_url, server_id=server_id)
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        json_body (DetachBackup): Detach Any Attached Backup from a Server
