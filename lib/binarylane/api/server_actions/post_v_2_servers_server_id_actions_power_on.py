...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/v2/servers/{server_id}/actions#PowerOn".format(client.base_url, server_id=server_id)
...
def sync_detailed(
    ...
    *,
    ...
    """Power a Server On
     ...
     This may be used if the server has previous been powered off either from inside the server's
