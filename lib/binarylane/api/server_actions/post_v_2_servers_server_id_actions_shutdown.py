...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/v2/servers/{server_id}/actions#Shutdown".format(client.base_url, server_id=server_id)
...
def sync_detailed(
    ...
    *,
    ...
    """Request a Server Perform a Shutdown
     ...
     This is a 'soft' shutdown, equivalent to tapping the power button on the server or selecting
