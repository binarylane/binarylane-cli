...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/v2/servers/{server_id}/actions#Uncancel".format(client.base_url, server_id=server_id)
...
def sync_detailed(
    ...
    *,
     ...
     **NB: this is only available before the server is suspended and we make no guarantees that un-
