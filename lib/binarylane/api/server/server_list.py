...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[Any, ServersResponse]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[Any, ServersResponse]]:
    return Response(
