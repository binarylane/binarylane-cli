...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[Any, NeighborsResponse]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[Any, NeighborsResponse]]:
    return Response(
