...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/v2/servers/{server_id}/actions#ChangeSeparatePrivateNetworkInterface".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Enable or Disable a Separate Private Network Interface for a Server in a VPC
     ...
     This is used to enable or disable a separate second network interface for VPC network traffic (if
