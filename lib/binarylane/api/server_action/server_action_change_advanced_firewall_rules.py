...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/v2/servers/{server_id}/actions#ChangeAdvancedFirewallRules".format(client.base_url, server_id=server_id)
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        json_body (ChangeAdvancedFirewallRules): Change the Advanced Firewall Rules for a Server
