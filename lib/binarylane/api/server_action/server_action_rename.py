...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/v2/servers/{server_id}/actions#Rename".format(client.base_url, server_id=server_id)
...
def sync_detailed(
    ...
    *,
    ...
    """Rename a Server
     ...
     This is used to change the name of the server in our system. The name in the server's operating
    system will not be changed.

    Args:
        server_id (int): The ID of the server on which the action should be performed.
        json_body (Rename): Rename a Server
