...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/v2/servers/{server_id}/actions#PasswordReset".format(client.base_url, server_id=server_id)
...
def sync_detailed(
    ...
    *,
    ...
    """Reset the Password of a Server
     ...
     This will reset the password of the specified or default remote user if possible (e.g. on most Unix
