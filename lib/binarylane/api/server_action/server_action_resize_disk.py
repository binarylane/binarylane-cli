...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/v2/servers/{server_id}/actions#ResizeDisk".format(client.base_url, server_id=server_id)
...
def sync_detailed(
    ...
    *,
    ...
    """Alter the Size of an Existing Disk for a Server
     ...
     This is used to alter the size of an existing disk, either to use or create unallocated storage
    space.
    This does not alter the total disk space available to your server: to add or remove disk space for
