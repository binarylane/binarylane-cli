...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/v2/servers/{server_id}/actions#Ping".format(client.base_url, server_id=server_id)
...
def sync_detailed(
    ...
    *,
    ...
    """Attempt to Ping a Server
     ...
     This is used to determine if the server responds to a ping. The ping attempt is normally made to the
