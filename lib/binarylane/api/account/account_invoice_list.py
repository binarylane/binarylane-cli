...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[Any, InvoicesResponse]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[Any, InvoicesResponse]]:
    return Response(
