...
T = TypeVar("T", bound="ChangeSizeOptionsRequest")


@attr.s(auto_attribs=True)
class ChangeSizeOptionsRequest:
    """
    Attributes:
        ...
        ipv4_addresses_to_remove (Union[Unset, None, List[str]]): If you are reducing the number of IPv4 addresses you
            must specify which addresses to remove. If you specify more IPv4 addresses to remove than the number of IPv4
            addresses being removed the extra IPv4 addresses will be re-provisioned with new addresses.
    """
    ...
    ipv4_addresses_to_remove: Union[Unset, None, List[str]] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        ipv4_addresses_to_remove: Union[Unset, None, List[str]] = UNSET
        if not isinstance(self.ipv4_addresses_to_remove, Unset):
            if self.ipv4_addresses_to_remove is None:
                ipv4_addresses_to_remove = None
            else:
                ipv4_addresses_to_remove = self.ipv4_addresses_to_remove
        ...
        if ipv4_addresses_to_remove is not UNSET:
            field_dict["ipv4_addresses_to_remove"] = ipv4_addresses_to_remove
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        ipv4_addresses_to_remove = cast(List[str], d.pop("ipv4_addresses_to_remove", UNSET))

        change_size_options_request = cls(
            ...
            disk=disk,
            transfer=transfer,
            ipv4_addresses_to_remove=ipv4_addresses_to_remove,
        )

        change_size_options_request.additional_properties = d
        return change_size_options_request
