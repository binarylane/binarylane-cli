...
T = TypeVar("T", bound="RouteEntryRequest")


@attr.s(auto_attribs=True)
class RouteEntryRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        route_entry_request = cls(
            router=router,
            destination=destination,
            description=description,
        )

        route_entry_request.additional_properties = d
        return route_entry_request
